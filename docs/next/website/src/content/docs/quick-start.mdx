...
Herdr launches or attaches to your default background session. You do not manage sockets. If you detach, agents keep running. The current session name appears in the expanded sidebar header.

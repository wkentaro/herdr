...
fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::SessionKill(_) => "session.kill",
        ...
        Method::WorkspaceFolderCreate(_) => "workspace.folder.create",
        Method::WorkspaceFolderRename(_) => "workspace.folder.rename",
        Method::WorkspaceFolderDelete(_) => "workspace.folder.delete",
        Method::WorkspaceFolderMove(_) => "workspace.folder.move",
